            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="banner-inner" data-aos="fade-up" data-aos-duration="1000">
                        <h1>Efficient building construction and complete construction solution service provider</h1>
            ...
            <div class="counting-inner">
                ...
                <div class="row text-center">
                    <div class=" col-12 counting-inner-content">
                        <div class="col-md-3 ">
                            <div class="counter">
                                <h2><span class="timer count-title count-number" data-to="25" data-speed="1500">0</span><span class="count-title">+</span></h2>
                                <p class="count-text ">Years of Experience</p>
                            </div>
                        </div>
                        <div class="col-md-3 ">
                            <div class="counter">
                                <h2><span class="timer count-title count-number" data-to="655" data-speed="1500">0</span><span class="count-title">+</span></h2>
                                <p class="count-text ">Projects Completed</p>
                            </div>
                        </div>
                        <div class="col-md-3 ">
                            <div class="counter">
                                <h2><span class="timer count-title count-number" data-to="35" data-speed="1500">0</span><span class="count-title">+</span></h2>
                                <p class="count-text ">Investors Gathered</p>
                            </div>
                        </div>
                        <div class="col-md-3 ">
                            <div class="counter">
                                <h2><span class="timer count-title count-number" data-to="45" data-speed="1500">0</span><span class="count-title">+</span></h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="services-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Faucibus a pellentesque sit amet. Ullamcorper di gnissim cras tincidunt lobortis feugiat vivamus at. Lorem ipsum adipiscing elit, sed do eiusmod tempor incididunt ut labore...</p>
                            </div>
                            <div class="col-md-6">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Faucibus a pellentesque sit amet. Ullamcorper di gnissim cras tincidunt lobortis feugiat vivamus at. Lorem ipsum adipiscing elit, sed do eiusmod tempor incididunt ut labore...</p>
                            </div>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 ">
                                                    <div class="content-2">
                                                        <h3>The Empire Estate ( China )</h3>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Faucibus a pellent esque sit amet. Ullamcorper di gnissim cras tincidunt lobortis feugiat vivamus at. Lorem ipsum adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                                                        <p class="text">Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Faucibus a pellent esque sit amet. Ullamcorper di gnissim cras tincidunt lobortis feugiat vivamus at. Lorem ipsum </p>
                ...
                <div class="col-lg-6 construction-team-inner">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Faucibus a pellent esque sit amet. adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="testimonials-content block">
                                ...
                                <div class="col-md-9 content">
                                    <p>“Lorem ipsum dolor sit amet, consectetur adi piscing elit, sed do eiusmod tempor incididunt ut. Faucibus a pellent esque sit amet. adipiscing elit, sed do eiusmod...”</p>
                                    <span>Simon Andrew</span>
                                    <h6>Manager, Eskka Constructions</h6>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="testimonials-content">
                                <div class="col-md-9">
                                    <p>“Piscing elit, sed do eiusmod tempor incididunt ut. Faucibus a pellent esque sit amet. adipiscing elit, sed do eiusmod...”</p>
                                    <span>Simon Andrew</span>
                                    <h6>Manager, Eskka Constructions</h6>
                                </div>
                                <div class="col-md-3">
            ...
            <div class="contact-us-inner">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 block">
                        ...
                        <p>Phone 1234 56 7890</p>
                        <a href="mailto:websiteconst.com" style="display:block;">info@websiteconst.com</a>
                        <a href="http://websiteconst.com" style="display: inline-block;border-bottom: 2px solid;">websiteconst.com</a>
                        <span>
                            <a href="">
                                <i class="fab fa-facebook-square"></i>
                            </a>
                    ...
                    <div class="col-xl-8 col-lg-8">
                        ...
                        <form data-aos="fade-up" data-aos-duration="1300">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-12">
                                    <input type="text" class="form-control" placeholder="Your Email" required style="float: right;">
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-inner">
                        ...
                        <p>(C) 2019, All Rights Reserved. Designed and Developed by <small><a href="https://www.template.net/editable/construction-website-templates">Template.net</a></small></p>
                    </div>
                </div>
            </div>
        </div>
